...
The manuscript source (`paper.md`) is maintained in the separate paper deposit
repository `mcp-governance-study-paper--zenodo` and published as the Zenodo
deposit above. This `paper/` directory exists only as this pointer, so that the
in-code references to "Section X.Y" resolve to a citable location.
