# Sensitivity Validation Review: 100 Tool Classifications

Review each tool and classify its **sensitivity** (orthogonal to read/write).

Decision rule: If the tool's output or action would be subject to access
control, audit requirements, or regulatory obligations in a well-governed
deployment, classify as **sensitive**.
...
Tools 1-60 are classified as sensitive by the deterministic heuristic.
Tools 61-100 are classified as non-sensitive (check for false negatives).

---

## 1. `memory_store` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | config+key | non-sensitive |
...
## 2. `ryvo_protocol_config` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | config+token | sensitive |
...
## 3. `drift_session_create` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | session+token | sensitive |

*(Source not available -- classify from name and description)*

---

## 4. `board_read` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | payment | non-sensitive |
...
## 5. `send_invite_link` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | password | sensitive |
...
## 6. `jingswap_cancel_sbtc` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | refund | sensitive |
...
## 7. `get_deposit_invoice` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | invoice | sensitive |
...
## 9. `wallet_rotate_password` [DET-SENSITIVE]
...
## 10. `security_quick_scan` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | secret | non-sensitive |
...
## 11. `baserow_auth_login` [DET-SENSITIVE]
...
## 12. `validate_iban` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | payment | sensitive |
...
## 13. `get_hiro_api_key` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | api_key, environment+variable | sensitive |
...
## 14. `create_api_key` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | api_key | sensitive |
...
## 15. `get_smart_hook_env_vars` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | environment+variable | sensitive |
...
## 16. `generate_social_kit` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | purchase | non-sensitive |
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | purchase | sensitive |
...
## 18. `Security Agent` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | credential | sensitive |

*(Source not available -- classify from name and description)*

---

## 19. `create_app` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | secret | sensitive |
...
## 20. `lightning_pay_invoice` [DET-SENSITIVE]
...
## 21. `renew_access_token` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | access_token | sensitive |
...
## 22. `generate_invite_link` [DET-SENSITIVE]
...
## 23. `1ly_update_link` [DET-SENSITIVE]
...
## 24. `moltguard_credential_issue` [DET-SENSITIVE]
...
## 25. `1ly_list_keys` [DET-SENSITIVE]
...
## 26. `list_global_environment_variables` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | environment+variable | non-sensitive |
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | payment, invoice | sensitive |
...
## 28. `claim_api_key` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | billing | sensitive > confidentiality |
...
## 30. `healthcare/literature-search` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | medical | non-sensitive |
...
## 32. `salary_ai_risk` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | salary | non-sensitive |
...
## 33. `archive35_run_command` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | run_command | sensitive |
...
## 34. `credentials_list` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | credential | non-sensitive |
...
## 35. `create_purchase_intent` [DET-SENSITIVE]
...
## 37. `find_opendart_compensation` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | compensation | sensitive |
...
## 39. `gw_reset_password` [DET-SENSITIVE]
...
## 40. `backup_database` [DET-SENSITIVE]
...
## 41. `ssh_resolve_host` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | config+connection | sensitive |
...
## 42. `get_connection_string` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | connection_string | sensitive |
...
## 43. `decode_invoice` [DET-SENSITIVE]
...
## 44. `create_api_authorization` [DET-SENSITIVE]
...
## 45. `verify_session_factor` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | passport | sensitive |
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | billing | sensitive |
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | diagnosis | sensitive |
...
## 49. `ryvo_gateway_call` [DET-SENSITIVE]
...
## 50. `create_session_login_token` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | password, session+token | sensitive |
...
## 51. `get_restock_suggestions` [DET-SENSITIVE]
...
## 52. `retrieve_credential` [DET-SENSITIVE]
...
## 53. `create_account` [DET-SENSITIVE]
...
## 55. `list_supported_stocks` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | confidentiality | api_key | non-sensitive |
...
## 56. `peptide_properties` [DET-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| sensitive | autonomy | charge | non-sensitive |
...
## 57. `credentials_set` [DET-SENSITIVE]
...
## 60. `ryvo_gateway_call_with_headers` [DET-SENSITIVE]
...
## 61. `deep_research_report` [DET-NON-SENSITIVE]
...
## 62. `tapd_get_test_plan_count` [DET-NON-SENSITIVE]
...
## 63. `get_market_info` [DET-NON-SENSITIVE]
...
## 64. `get_project_schemes` [DET-NON-SENSITIVE]
...
## 65. `paean_list_tasks` [DET-NON-SENSITIVE]
...
## 66. `ActivateObjects` [DET-NON-SENSITIVE]
...
## 67. `GetNodeStructureLow` [DET-NON-SENSITIVE]
...
## 68. `GetVirtualFoldersLow` [DET-NON-SENSITIVE]
...
## 69. `emergency_status` [DET-NON-SENSITIVE]
...
## 70. `update_event` [DET-NON-SENSITIVE]
...
## 71. `fedbrain_search` [DET-NON-SENSITIVE]
...
## 72. `agent_spawn` [DET-NON-SENSITIVE]
...
## 73. `drift_java` [DET-NON-SENSITIVE]
...
## 74. `file_upload_delete` [DET-NON-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| non-sensitive | -- | -- | sensitive > integrity |
...
## 75. `cache_status` [DET-NON-SENSITIVE]
...
## 76. `audit_mcp_server` [DET-NON-SENSITIVE]
...
| Det Sensitivity | Det Category | Signals | HUMAN |
|-----------------|--------------|---------|-------|
| non-sensitive | -- | -- | sensitive > autonomy |
...
## 77. `ReadMetadataExtension` [DET-NON-SENSITIVE]
...
## 78. `ordinals_p2p_counter` [DET-NON-SENSITIVE]
...
## 80. `pattern_store` [DET-NON-SENSITIVE]
...
## 81. `verify_audit_chain` [DET-NON-SENSITIVE]
...
## 82. `get_top_expenses` [DET-NON-SENSITIVE]
...
## 83. `memory_search_unified` [DET-NON-SENSITIVE]
...
## 84. `get_transport_classification` [DET-NON-SENSITIVE]
...
## 85. `opengrok_update_memory` [DET-NON-SENSITIVE]
...
## 86. `get_settings_metadata` [DET-NON-SENSITIVE]
...
## 87. `sona/lora/apply-base` [DET-NON-SENSITIVE]
...
## 88. `get_dividends` [DET-NON-SENSITIVE]
...
## 89. `list_recent_briefs` [DET-NON-SENSITIVE]
...
## 90. `get_board_labels` [DET-NON-SENSITIVE]
...
## 91. `get_summary_profile` [DET-NON-SENSITIVE]
...
## 92. `BuyWhere Singapore catalog` [DET-NON-SENSITIVE]
...
## 93. `search_geolocations` [DET-NON-SENSITIVE]
...
## 94. `sqlite_transaction_rollback` [DET-NON-SENSITIVE]
...
## 95. `klaviyo_events_get_profile` [DET-NON-SENSITIVE]
...
## 96. `ruvllm_sona_create` [DET-NON-SENSITIVE]
...
## 97. `morph_list_supermodels` [DET-NON-SENSITIVE]
...
## 98. `get_text_extents` [DET-NON-SENSITIVE]
...
## 99. `ActivateDataElementLow` [DET-NON-SENSITIVE]
...
## 100. `get_transcript` [DET-NON-SENSITIVE]
