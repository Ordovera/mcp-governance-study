"""
Phase F: re-run cc-mcp-audit's extractTools on the residual false-negative
servers using the new Patterns O1/O2/P (Python) and J1/J2 (Go) plus the
...
CHECKPOINT_FILE = Path("phase-f-checkpoint.json")
INPUT_CORPUS = "evidence_corpus_n1000_post_phasee.json"
OUTPUT_CORPUS = "evidence_corpus_n1000_post_phasef.json"
TIMEOUT_CLONE = 60
...
"""
    tmp_helper = Path(gettempdir()) / "phase-f-helper.mjs"
...
def main():
    ...
    print(f"Phase F target: {len(fn)} residual false-negative servers")
